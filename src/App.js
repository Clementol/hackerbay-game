...
class App extends Component {
	...
	handleOnLoad(width,height){
		...
		let truncated_data = shuffled_data.slice(0,parseInt(this.state.matrix_size,10)/width)

		for (let i = 0; i < truncated_data.length; i++) {
			let elem_position = document.getElementById(truncated_data[i])
			elem_position.innerHTML="<img src='./mario-mashroomg.jpeg' alt='mario' class='maze-image'/>";
